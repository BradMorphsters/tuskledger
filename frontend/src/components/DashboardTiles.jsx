...
import { Activity, TrendingDown, TrendingUp, Calendar, Heart, Settings, PieChart } from 'lucide-react'
import { getFinancialPulse, getCashFlowForecast, getTransactions, getHsaStatus, getInvestmentsSummary } from '../api/client'
