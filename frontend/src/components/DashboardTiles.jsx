...
import { Activity, TrendingDown, TrendingUp, Calendar, Heart, Settings } from 'lucide-react'
import { getFinancialPulse, getCashFlowForecast, getTransactions, getHsaStatus } from '../api/client'
