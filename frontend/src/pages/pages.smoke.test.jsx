...
vi.mock('../api/client', () => ({
  ...
  getAgentTradingUniverseReview: vi.fn(() => Promise.resolve({ add: [], add_edgar: [], drop: [], below_floor_screened: 0, ignored: [], kept: [], configured: true })),
  decideAgentTradingUniverseCandidate: vi.fn(() => Promise.resolve({ ok: true })),
  decideAgentTradingUniverseBulk: vi.fn(() => Promise.resolve({ ok: true, names: [] })),
  rejectAgentTradingProposal:  vi.fn(() => Promise.resolve({ ok: true })),
  reconcileAgentTradingOrders: vi.fn(() => Promise.resolve({ reconciled: [] })),
  getAgentTradingRanking:    vi.fn(() => Promise.resolve({ configured: false, profile: 'rotation', ranking: [] })),
  getAgentTradingSleeve:     vi.fn(() => Promise.resolve({ connected: false, armed: false, cash: null, deployable: null })),
